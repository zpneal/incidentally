...
Given a social network among 15 people, we can simulate their recruitment by three new organizations:
```{r, fig.show="hold", out.width="40%"}
par(mar = c(0, 0, 1, 0))
G <- erdos.renyi.game(15, .33)  #A random social network of 15 people, as igraph
