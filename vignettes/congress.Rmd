...
## Welcome {#welcome}
This vignette describes how to use the `incidentally` package to obtain data on bill sponsorship in US Congress, and how to use the `backbone` package to construct political networks from these data. For a more general introduction to the `incidentally` package, see [the main vignette](incidentally.html).
